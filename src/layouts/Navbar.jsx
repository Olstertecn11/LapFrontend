  ...
  return (
    <div>
      <nav className="navbar navbar-expand-lg navbar-light bg-light">
        <a className="navbar-brand" href="#" style={{ color: '#db963e' }}> <img width={30} style={{ marginTop: '-4px' }} src="https://lh3.googleusercontent.com/proxy/nzF5mPZ1DQY7Bdg5TJ9AKZBS2MCiHlmSnkmQllSWagvMtuEhjR2I3_1ZZGrGmwP5SqStTQBVnpgcc9ZgyKtDsOt3wftlKkV7r82DlbSIpH9XgAWonh1cJBUknCg3-_cu1dVkNRqMmt--zuEi5jRm-Lv-5_sdqQ" alt="" /> <b>Liceo Adventista El Progreso</b></a>
